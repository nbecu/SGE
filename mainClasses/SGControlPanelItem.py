...
class SGControlPanelItem(QtWidgets.QWidget):
    def __init__(self,parent,entity,y,texte="",color=Qt.black,valueOfAttribut="",nameOfAttribut=""):
    ...
    def getActionItemLayout(self):
        self.actionItemLayout.addWidget( self.entity.getWidget())
        self.actionItemLayout.addWidget( QtWidgets.QLabel(self.texte))
        widget = QCheckBox()
        widget.setCheckState(Qt.Checked)

        self.actionItemLayout.addWidget(widget)
        return self.actionItemLayout 
