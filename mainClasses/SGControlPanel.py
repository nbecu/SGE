...
class SGControlPanel(SGGameSpace):
    def __init__(self,parent,player,actionItems,borderColor=Qt.black,backgroundColor=Qt.transparent):
        super().__init__(parent,0,60,0,0,true,backgroundColor)
        self.player=parent
        self.id=self.player.name
    ...
    def checkDisplay(self):
        return self.model.whoIAm==self.playerName
