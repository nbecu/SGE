...
# ============================================================================
    ...
    def newCellsOnGrid(self, columns=10, rows=10, format="square", size=30, gap=0, backgroundColor=Qt.gray, borderColor=Qt.black, moveable=True, name=None, backGroundImage=None, defaultCellColor=Qt.white, defaultCellImage=None, neighborhood='moore', boundaries='open', zoomMode="magnifier") -> SGCellType:
        ...
        self.gameSpaces[name if name is not None else aGrid.id] = aGrid
...
# ============================================================================
    ...
    def newDashBoard(self, title=None, borderColor=Qt.black, borderSize=1, backgroundColor=QColor(230, 230, 230), textColor=Qt.black, layout ='vertical'):
        ...
        self.gameSpaces[title if title is not None else aDashBoard.id] = aDashBoard
    ...
    def newEndGameRule(self, title='EndGame Rules', numberRequired=1, displayRefresh='instantaneous', isDisplay=True, borderColor=Qt.black, backgroundColor=Qt.lightGray, layout="vertical", textColor=Qt.black,
        ...
        self.gameSpaces[title if title is not None else aEndGameRule.id] = aEndGameRule
    ...
    def newVoid(self, name, sizeX=200, sizeY=200):
        ...
        self.gameSpaces[name if name is not None else aVoid.id] = aVoid
    ...
    def newProgressGauge(self,simVar,minimum=0,maximum=100, title=None,orientation="horizontal",colorRanges=None,unit="",
        ...
        self.gameSpaces[title if title is not None else aProgressGauge.id] = aProgressGauge
    ...
    def newLegend(self, name='Legend', alwaysDisplayDefaultAgentSymbology=False):#, grid=None):
        ...
        self.gameSpaces[name if name is not None else aLegend.id] = aLegend
    ...
    def newUserSelector(self, customListOfUsers=None, orientation='horizontal', title='userSelector'):
        """
        ...
        Args:
            ...
            title (str, optional): Name for getGameSpaceByName; default 'userSelector'.
        """
        if customListOfUsers or (len(self.getUsers_withControlPanel()) > 1 and len(self.players) > 0):
            ...
            userSelector = SGUserSelector(self, usersList, orientation, title)
            self.userSelector = userSelector
            self.gameSpaces[title if title is not None else userSelector.id] = userSelector
    ...
    def newTimeLabel(self, title=None, backgroundColor=Qt.white, borderColor=Qt.black, textColor=Qt.black,
        ...
        self.gameSpaces[title if title is not None else aTimeLabel.id] = aTimeLabel
    ...
    def newTextBox(self, textToWrite='', title='Text Box', width=None, height=None,
     borderColor=Qt.black, backgroundColor=Qt.lightGray, titleAlignment='left', shrinked=True, chronologicalOrder=True):
        ...
        self.gameSpaces[title if title is not None else aTextBox.id] = aTextBox
