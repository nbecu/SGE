...
class SGTextBoxLarge_DEPRECATED(SGGameSpace):
    """
    DEPRECATED: This class is deprecated. Use SGTextBox instead.
    ...
    def __init__(self, parent, textToWrite, title, width=None, height=None, 
        ...
        warnings.warn(
            "SGTextBoxLarge is deprecated. Use SGTextBox instead.",
            DeprecationWarning,
            stacklevel=2
        )
...
class SGTextBox_DEPRECATED(SGGameSpace):
    """
    DEPRECATED: This class is deprecated. Use SGTextBox instead.
    ...
    def __init__(self, parent, textToWrite, title, width=None, height=None, shrinked=True,
                 borderColor=Qt.black, backgroundColor=Qt.lightGray, titleAlignment='left'):
        warnings.warn(
            "SGTextBox_DEPRECATED is deprecated. Use SGTextBox instead.",
            DeprecationWarning,
            stacklevel=2
        )
        super().__init__(parent, 0, 60, 0, 0, true, backgroundColor)
