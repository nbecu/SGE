...
hexCell = myModel.newCellsOnGrid(4, 4, "hexagonal", name="HexGrid", size=40, gap=2)
...
SquareAgents.newAgentsAtRandom(6, hexCell, condition=lambda c: c.isValue("terrain", "grass"))
