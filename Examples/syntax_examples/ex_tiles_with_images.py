...
flipAction1 = myModel.newFlipAction(CardTile1, aNumber='infinite', aNameToDisplay="🔄 Flip Pair Cards")
flipAction2 = myModel.newFlipAction(CardTile2, aNumber='infinite', aNameToDisplay="🔄 Flip Triplet Cards")
flipAction3 = myModel.newFlipAction(CardTile3, aNumber='infinite', aNameToDisplay="🔄 Flip Singlet Cards")
flipAction4 = myModel.newFlipAction(CardTile4, aNumber='infinite', aNameToDisplay="🔄 Flip Custom Cards")
