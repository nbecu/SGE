...
flipActionTopLeft = myModel.newFlipAction(TileTopLeft, aNumber='infinite', label="🔄 Flip TopLeft Tiles",action_controler={"directClick":True})
flipActionTopRight = myModel.newFlipAction(TileTopRight, aNumber='infinite', label="🔄 Flip TopRight Tiles",action_controler={"directClick":True})
flipActionBottomLeft = myModel.newFlipAction(TileBottomLeft, aNumber='infinite', label="🔄 Flip BottomLeft Tiles",action_controler={"directClick":True})
flipActionBottomRight = myModel.newFlipAction(TileBottomRight, aNumber='infinite', label="🔄 Flip BottomRight Tiles",action_controler={"directClick":True})
...
moveActionCenter = myModel.newMoveAction(TileCenter, aNumber='infinite', label="↔️ Move Center Tiles",action_controler={"directClick":True})
moveActionTopLeft = myModel.newMoveAction(TileTopLeft, aNumber='infinite', label="↔️ Move TopLeft Tiles",action_controler={"directClick":True})
moveActionTopRight = myModel.newMoveAction(TileTopRight, aNumber='infinite', label="↔️ Move TopRight Tiles",action_controler={"directClick":True})
moveActionBottomLeft = myModel.newMoveAction(TileBottomLeft, aNumber='infinite', label="↔️ Move BottomLeft Tiles",action_controler={"directClick":True})
moveActionBottomRight = myModel.newMoveAction(TileBottomRight, aNumber='infinite', label="↔️ Move BottomRight Tiles",action_controler={"directClick":True})
moveActionFull = myModel.newMoveAction(TileFull, aNumber='infinite', label="↔️ Move Full Tile",action_controler={"directClick":True})
