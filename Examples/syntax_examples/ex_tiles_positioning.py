...
# Note: Now uses aNameToDisplay (consistent with other action methods)
flipActionCenter = myModel.newFlipAction(TileCenter, aNumber='infinite', aNameToDisplay="🔄 Flip Center Tiles")
flipActionTopLeft = myModel.newFlipAction(TileTopLeft, aNumber='infinite', aNameToDisplay="🔄 Flip TopLeft Tiles")
flipActionTopRight = myModel.newFlipAction(TileTopRight, aNumber='infinite', aNameToDisplay="🔄 Flip TopRight Tiles")
flipActionBottomLeft = myModel.newFlipAction(TileBottomLeft, aNumber='infinite', aNameToDisplay="🔄 Flip BottomLeft Tiles")
flipActionBottomRight = myModel.newFlipAction(TileBottomRight, aNumber='infinite', aNameToDisplay="🔄 Flip BottomRight Tiles")
flipActionFull = myModel.newFlipAction(TileFull, aNumber='infinite', aNameToDisplay="🔄 Flip Full Tile")

# Add Move action for all tile types to test tile movement
# Note: newMoveAction uses 'aNameToDisplay' (not 'nameToDisplay' like newFlipAction)
moveActionCenter = myModel.newMoveAction(TileCenter, aNumber='infinite', aNameToDisplay="↔️ Move Center Tiles")
moveActionTopLeft = myModel.newMoveAction(TileTopLeft, aNumber='infinite', aNameToDisplay="↔️ Move TopLeft Tiles")
moveActionTopRight = myModel.newMoveAction(TileTopRight, aNumber='infinite', aNameToDisplay="↔️ Move TopRight Tiles")
moveActionBottomLeft = myModel.newMoveAction(TileBottomLeft, aNumber='infinite', aNameToDisplay="↔️ Move BottomLeft Tiles")
moveActionBottomRight = myModel.newMoveAction(TileBottomRight, aNumber='infinite', aNameToDisplay="↔️ Move BottomRight Tiles")
moveActionFull = myModel.newMoveAction(TileFull, aNumber='infinite', aNameToDisplay="↔️ Move Full Tile")
