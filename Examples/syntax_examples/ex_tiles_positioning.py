...
flipActionCenter = myModel.newFlipAction(TileCenter, label="🔄 Flip Center Tiles")
flipActionTopLeft = myModel.newFlipAction(TileTopLeft, label="🔄 Flip TopLeft Tiles",action_controler={"directClick":True})
flipActionTopRight = myModel.newFlipAction(TileTopRight, label="🔄 Flip TopRight Tiles",action_controler={"directClick":True})
flipActionBottomLeft = myModel.newFlipAction(TileBottomLeft, label="🔄 Flip BottomLeft Tiles",action_controler={"directClick":True})
flipActionBottomRight = myModel.newFlipAction(TileBottomRight, label="🔄 Flip BottomRight Tiles",action_controler={"directClick":True})
flipActionFull = myModel.newFlipAction(TileFull, label="🔄 Flip Full Tile")
...
moveActionCenter = myModel.newMoveAction(TileCenter, label="↔️ Move Center Tiles",action_controler={"directClick":True})
moveActionTopLeft = myModel.newMoveAction(TileTopLeft, label="↔️ Move TopLeft Tiles",action_controler={"directClick":True})
moveActionTopRight = myModel.newMoveAction(TileTopRight, label="↔️ Move TopRight Tiles",action_controler={"directClick":True})
moveActionBottomLeft = myModel.newMoveAction(TileBottomLeft, label="↔️ Move BottomLeft Tiles",action_controler={"directClick":True})
moveActionBottomRight = myModel.newMoveAction(TileBottomRight, label="↔️ Move BottomRight Tiles",action_controler={"directClick":True})
moveActionFull = myModel.newMoveAction(TileFull, label="↔️ Move Full Tile",action_controler={"directClick":True})
