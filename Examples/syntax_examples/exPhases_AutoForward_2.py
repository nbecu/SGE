...
myModel.timeManager.newModelPhase(aModelAction2, name = 'Model Phase 2',autoForwardOn=True,messageAutoForward="The land use has evolve. Continue to next turn")
