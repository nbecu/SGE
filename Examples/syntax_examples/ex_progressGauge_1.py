...
jaugeQoL = myModel.newProgressGauge(simVarQoL,-2,10,"Qualité de vie", orientation='vertical',bar_width='fit title size')

jaugeEnv = myModel.newProgressGauge(simVarEnv, -2,  10, "Environnement", bar_length=60,bar_width=60,colorRanges=[(-10,0,"red"),(0,10,"blue")])
jaugeEnv.setThresholdValue(6, lambda: print("Up Env"), lambda: print("Down Env"))

jaugeAtt = myModel.newProgressGauge(simVarAttract, -2,  10, "Attractivité", bar_width=10)
...
myModel.newButton((lambda: changeAll(1)),'Add 1',(320,270))

myModel.newButton((lambda: changeAll(-1)),'Remove 1',(320,290))

myModel.newButton((lambda: addGivenValue()),'add "x"',(320,320))
