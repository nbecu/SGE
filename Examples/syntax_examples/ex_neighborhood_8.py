...
myModel = SGModel(650, 450, windowTitle="Wolf hunts closest sheep (radius 3) using getClosestAgentMatching + moveTowards")

Cell = myModel.newCellsOnGrid(
    columns=12, rows=8, format="square", gap=0, size=40, neighborhood='moore', boundaries='closed'
)
...
# Agent species
Sheep = myModel.newAgentSpecies("Sheep", "ellipseAgent1", defaultSize=18, locationInEntity="center", defaultColor=Qt.white)
Wolf  = myModel.newAgentSpecies("Wolf",  "ellipseAgent2", defaultSize=20, locationInEntity="center", defaultColor=Qt.red)
