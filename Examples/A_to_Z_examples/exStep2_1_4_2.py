...
myModel=SGModel(700,700, windowTitle="Create your grid with a custom background and border settings")
...
Cell.grid.setBackgroundColor(Qt.orange)
Cell.grid.setBorderColor(Qt.red)
Cell.grid.setBorderSize(6)
Cell.grid.setBorderStyle('dotted')
Cell.grid.setBorderRadius(14)
