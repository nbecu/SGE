...
# 3. Player selection happens later when the game window opens  "91.173.78.45 "192.168.1.20"

myModel.enableDistributedGame(num_players=(2,4),broker_host="91.173.78.45", broker_port=18883)
