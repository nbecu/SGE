...
Update1=myModel.newModifyAction(Cells,{"incitation":"bonus"},conditions=[lambda: (Cells.nb_withValue("incitation","bonus")+Cells.nb_withValue("incitation","malus"))<30],writeAttributeInLabel=True)
Update2=myModel.newModifyAction(Cells,{"incitation":"malus"},conditions=[lambda: (Cells.nb_withValue("incitation","bonus")+Cells.nb_withValue("incitation","malus"))<30],writeAttributeInLabel=True)
