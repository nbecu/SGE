...
myModel=SGModel(600,600, windowTitle="Custom your grid", typeOfLayout='vertical')
...
myModel.newPov("povLandUse","landUse",{"grass":Qt.green,"shrub":Qt.yellow,"forest":Qt.darkGreen},[aGrid])
